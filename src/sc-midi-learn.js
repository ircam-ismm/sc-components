...
/*    :host > div {
    ...
    .panelLine {
      ...
      border-top: solid 1px var(--sc-color-primary-)}
    }
  ...
  constructor() {
    ...
    this.colorLayerBase = '#1c78c0ff';
    this.colorLayerSelected = '#d9534fff';
    this.colorLayerBound = '#5ec451ff';
  ...
  render() {
    return html`
      <sc-button
        ...
        ?selected="${this._connected && this.active}"
