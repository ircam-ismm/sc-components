...
<div>
  ...
  <sc-radio
    options="${JSON.stringify(["question","info","github","burger","gear","save","delete"])}"
    value="question"
    @change=${t=>document.querySelector("#test-icon").icon=t.detail.value}
  ></sc-radio>
</div>
<div>
