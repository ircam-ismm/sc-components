...
<div>
  ...
  <sc-radio
    id="radio-change"
    options="${JSON.stringify(r)}"
    @change=${t=>document.querySelector("#test-radio").value=t.detail.value}
  ></sc-radio>
</div>
<div>
  ...
  <sc-editor
    ...
    @change=${t=>{document.querySelector("#test-radio").options=JSON.parse(t.detail.value),document.querySelector("#radio-change").options=JSON.parse(t.detail.value)}}
  ></sc-editor>
</div>
<div>
  ...
  <sc-radio
    ...
    value="vertical"
    @change=${t=>document.querySelector("#test-radio").orientation=t.detail.value}
  ></sc-radio>
</div>
<div>
  <sc-text readonly>[?disabled=false]</sc-text>
  <sc-toggle
    @change=${t=>document.querySelector("#test-radio").disabled=t.detail.value}
  ></sc-toggle>
</div>
