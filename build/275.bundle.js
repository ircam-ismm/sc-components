"use strict";(self.webpackChunk_ircam_sc_components_doc=self.webpackChunk_ircam_sc_components_doc||[]).push([[275],{7275:(e,t,i)=>{i.r(t),i.d(t,{template:()=>r});var a=i(9392),n=i(1142),s=i(4670);const c={path:"docs",name:"docs",children:[{path:"docs/inner",name:"inner",children:[{path:"docs/inner/niap.md",name:"niap.md",size:1584,extension:".md",type:"file"},{path:"docs/inner/test.md",name:"test.md",size:1588,extension:".md",type:"file"}],size:3172,type:"directory"},{path:"docs/niap.md",name:"niap.md",size:1584,extension:".md",type:"file"},{path:"docs/test.md",name:"test.md",size:1588,extension:".md",type:"file"}],size:3172,type:"directory"},r=a.dy`
...
<div>
  <p>
    Add create, rename, delete interface on the filetree, be aware that the value
...
<div>
  ...
  <sc-editor
    ...
    @change=${e=>document.querySelector("#test-filetree").value=n.parse(e.detail.value)}
  ></sc-editor>
</div>
