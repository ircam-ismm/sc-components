...
<sc-loop
  id="test-loop"
  @change=${t=>document.querySelector("#loop-change").active=t.detail.value}
></sc-loop>
...
<div>
  ...
  <sc-toggle
    @change=${t=>document.querySelector("#test-loop").active=t.detail.value}
  ></sc-toggle>
</div>
<div>
  <sc-text>[?disabled=false]</sc-text>
  <sc-toggle
    @change=${t=>document.querySelector("#test-loop").disabled=t.detail.value}
  ></sc-toggle>
</div>
