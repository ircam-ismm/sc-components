/*! For license information please see 659.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_ircam_sc_components_doc=self.webpackChunk_ircam_sc_components_doc||[]).push([[659],{1659:(t,e,s)=>{s.r(e),s.d(e,{template:()=>o});var i=s(9392),r=s(2981);const o=i.dy`
...
<sc-slider
  id="test-slider"
  @input=${t=>document.querySelector("#slider-input").value=t.detail.value}
  @change=${t=>document.querySelector("#slider-change").value=t.detail.value}
></sc-slider>
...
<div>
  ...
  <sc-radio
    ...
    value="horizontal"
    @change=${t=>document.querySelector("#test-slider").orientation=t.detail.value}
  ></sc-radio>
</div>
<div>
