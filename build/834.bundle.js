"use strict";(self.webpackChunk_ircam_sc_components_doc=self.webpackChunk_ircam_sc_components_doc||[]).push([[834],{2834(e,t,c){c.r(t);var r=c(2182),o=c(1630);const a=r.qy`
...
<sc-io-surface
  ...
  @enter=${e=>{document.querySelector("#io-surface-enter-event").active=!0,document.querySelector("#io-surface-enter").value=JSON.stringify(e.detail.value)}}
  @exit=${e=>{document.querySelector("#io-surface-exit-event").active=!0,document.querySelector("#io-surface-exit").value=JSON.stringify(e.detail.value)}}
  @change=${e=>{document.querySelector("#io-surface-change-event").active=!0,document.querySelector("#io-surface-change").value=JSON.stringify(e.detail)}}
></sc-io-surface>
