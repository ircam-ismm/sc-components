...
<sc-dragndrop
  id="test-dragndrop"
  @change=${t=>{console.log(t.detail.value);let e="{";for(let s in t.detail.value)e+=`\n  ${s}: "${t.detail.value[s]}",`;e+="\n}",document.querySelector("#dragndrop-change").value=e}}
></sc-dragndrop>
...
- "raw": return File instances which is better suited for uploading assets to a server.
  ...
  <sc-radio
    ...
    value="load"
    @change=${t=>document.querySelector("#test-dragndrop").format=t.detail.value}
  ></sc-radio>
</div>
...
<div>
  ...
  <sc-radio
    ...
    value="idle"
    @change=${t=>document.querySelector("#test-dragndrop")._status=t.detail.value}
  ></sc-radio>
</div>
