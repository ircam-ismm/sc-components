...
<sc-record
  id="test-record"
  @change=${t=>document.querySelector("#record-change").active=t.detail.value}
></sc-record>
...
<div>
  ...
  <sc-toggle
    @change=${t=>document.querySelector("#test-record").disabled=t.detail.value}
  ></sc-toggle>
</div>
