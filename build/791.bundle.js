"use strict";(self.webpackChunk_ircam_sc_components_doc=self.webpackChunk_ircam_sc_components_doc||[]).push([[791],{3791:(e,t,i)=>{i.r(t),i.d(t,{enter:()=>o,template:()=>a});var s=i(182),n=i(4670);function c(e){const t=e.currentTarget.tagName.toLowerCase(),i=e.type,s=e.detail.value;document.querySelector("#log-events").value=`${t} - @${i}: ${s}`}function o(){}const a=s.dy`
